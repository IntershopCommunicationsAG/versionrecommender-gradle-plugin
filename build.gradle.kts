...
val pluginId = "com.intershop.gradle.versionrecommender"

gradlePlugin {
    plugins {
        create("versionrecommenderPlugin") {
            id = pluginId
...
pluginBundle {
    ...
    tags = listOf("intershop", "gradle", "plugin", "version", "dependencies", "versionrecommendation")
}
...
tasks {
    withType<Test>().configureEach {
        ...
        jvmArgs(mutableSetOf("-XX:MaxPermSize=96m"))
        minHeapSize = "64m"
        maxHeapSize = "128m"
...
bintray {
    ...
    pkg(delegateClosureOf<BintrayExtension.PackageConfig> {
        ...
        setLabels("intershop", "gradle", "plugin", "version", "dependencies", "versionrecommendation")
